        ...
        <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
            <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
                ...
                <HeroOrbit
                    ...
                    spinDuration="3s"
                >
                    <SparkleIcon className="size-5 text-emerald-400/20" />
                </HeroOrbit>
                <HeroOrbit size={520} rotation={-41} shouldOrbit={true} orbitDuration="34s">
                    <div className="size-2 rounded-full bg-emerald-400/20" />
                </HeroOrbit>
                <HeroOrbit
                    size={530}
                    rotation={178}
                    ...
                    spinDuration="3s"
                >
                    <SparkleIcon className="size-10 text-emerald-400/20" />
                </HeroOrbit>
                <HeroOrbit
                    size={550}
                    rotation={20}
                ...
                <HeroOrbit
                    ...
                    spinDuration="3s"
                >
                    <SparkleIcon className="size-14 text-emerald-400/20" />
                </HeroOrbit>
            ...
            <div className="container">
                <div className="flex flex-col items-center">
                    <Image
                        ...
                        alt="Person seeing behind the laptop"
                    />
