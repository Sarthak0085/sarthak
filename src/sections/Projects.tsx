                        ...
                        <div key={project.title} className="bg-gray-800 rounded-3xl relative z-0 after:z-10 overflow-hidden after:content[''] after:absolute after:inset-0 after:outline after:outline-2 after:-outline-offset-2 after:rounded-3xl after:outline-white/20 px-8 pt-8 md:px-10 md:pt-12 lg:pt-16 lg:px-20 after:pointer-events-none">
                            ...
                            <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                                <div className="lg:pb-16">
                                    <div className="bg-gradient-to-r bg-clip-text text-transparent from-emerald-300 to-sky-400 inline-flex font-bold uppercase tracking-widest text-sm gap-2">
                                        <span>{project?.company}</span>
                                        <span>&bull;</span>
                                        <span>{project?.year}</span>
                                    </div>
                                    <h3 className="text-2xl mt-2 font-serif md:text-4xl md:mt-5">{project?.title}</h3>
                                    <hr className="borde-t-2 border-white/5 mt-4 md:mt-5" />
